...
Build the script from the template at `${CLAUDE_PLUGIN_ROOT}/skills/enable-smart-prompts/template.sh`, substituting the chosen values. Show the final script to the user in a fenced code block. Summarize changes at the top:
